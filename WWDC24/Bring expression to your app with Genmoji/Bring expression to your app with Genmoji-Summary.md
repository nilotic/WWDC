...
- 세션 주제: **Bring expression to your app with Genmoji**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10220/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, I'm Aaron, an engineer for the Input Experience team.
  - `Express yourself`: Emoji are everywhere!
  - `Emoji enhancements`: This includes an updated emoji keyboard that takes the standard emoji we all know and love and combines it with your personalized content that can now be used like an emoji.
  - `NSAdaptiveImageGlyph`: Introducing NSAdaptiveImageGlyph, a brand new API to support using Genmoji and other personalized images just like a standard emoji!
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, I'm Aaron, an engineer for the Input Experience team.
    - Today, I'm happy to share with you some exciting new ways to enhance your app’s expressiveness with emoji.
  - **Express yourself**
    - Emoji are everywhere!
    - And why shouldn’t they be?
  - **Emoji enhancements**
    - This includes an updated emoji keyboard that takes the standard emoji we all know and love and combines it with your personalized content that can now be used like an emoji.
    - We’re talking Stickers, Memoji, Animoji, and a brand new way to make your own emoji called Genmoji.
  - **NSAdaptiveImageGlyph**
    - Introducing NSAdaptiveImageGlyph, a brand new API to support using Genmoji and other personalized images just like a standard emoji!
    - NSAdaptiveImageGlyphs are powered by a standard image format in a square aspect ratio with multiple resolutions, and bolstered by additional metadata such as a globally unique and stable identifier a content description that can be used for accessibility, and alignment metrics to allow proper layout and placement of images so they can be used with and formatted alongside regular text.
  - **Adopting in your app**
    - Now, let's take a look at just how easy it can be to support Genmoji in your application.
    - NSAdaptiveImageGlyph is natively supported by rich TextViews.
  - **Compatibility**
    - let's take a moment to talk about important compatibility considerations for your app.
  ...
  - **Wrap-up**
    - to the emoji experience available across all Apple platforms, including a brand new emoji keyboard, custom emoji creation with Genmoji, and multiple ways to support expressive images in your app with NSAdaptiveImageGlyph.
    - Whether using standard rich text views or a managing a fully custom typesetting solution, I encourage you to check out the latest SDK and see how easy it is to open up a whole new world of self-expression in your app with Genmoji.
...
- 세션 기반 체크포인트
  ...
  - `Adopting in your app`: Now, let's take a look at just how easy it can be to support Genmoji in your application.
  - `Compatibility`: let's take a moment to talk about important compatibility considerations for your app.

## ✅ 핵심 정리

- 이 세션은 **Bring expression to your app with Genmoji**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
