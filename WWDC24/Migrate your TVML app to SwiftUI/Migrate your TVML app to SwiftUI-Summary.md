...
- 세션 주제: **Migrate your TVML app to SwiftUI**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10207/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hello, and welcome to “Migrate your TVML app to SwiftUI.” I’m Jim, an engineer working on SwiftUI for tvOS, and I’m excited to show you the great features for tvOS apps in Swift...
  - `Lockups`: we described a moment ago.
  - `Shelves`: Let’s revisit the standard appearance of a content shelf to determine what we want to implement.
  - `Catalogs`: With just a few short lines of code, you’ve now replicated the look and feel of Apple’s own media apps, just as you would have using TVML back in tvOS 9.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    ...
    - In tvOS 18, SwiftUI has everything you need to build rich, fully-featured media catalog and streaming apps for your favorite set-top platform.
  - **Lockups**
    - we described a moment ago.
    - The most common type of lockup on tvOS consists of an image floating above some text.
  - **Shelves**
    - Let’s revisit the standard appearance of a content shelf to determine what we want to implement.
    - Our content should flow horizontally, and should align itself with the safe area bounds of the screen.
  - **Catalogs**
    - With just a few short lines of code, you’ve now replicated the look and feel of Apple’s own media apps, just as you would have using TVML back in tvOS 9.
    - To learn more about the new ScrollView modifiers in tvOS 18 and aligned releases, see "Demystify SwiftUI containers".
  - **Search**
    - Let’s find out how to quickly use what we’ve already built to provide a great search interface.
...
- 세션 기반 체크포인트
  ...
  - `Search`: For more information, see "What’s new in SwiftUI" to learn about the great new features arriving in tvOS 18 and aligned releases, find out more about new container APIs in "Demy...

## ✅ 핵심 정리

- 이 세션은 **Migrate your TVML app to SwiftUI**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
