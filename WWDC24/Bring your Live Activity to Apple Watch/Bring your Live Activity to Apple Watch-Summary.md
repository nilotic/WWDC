...
- 세션 주제: **Bring your Live Activity to Apple Watch**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10068/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, I'm Anne, and I’m a Frameworks engineer working on watchOS.
  - `Review your Live Activity`: Let’s get started by reviewing how your existing iOS Live Activity appears on Apple Watch in watchOS 11.
  - `Customize for Apple Watch`: You also have an opportunity to provide a custom Live Activity view for Apple Watch.
  - `Keep it live`: With just a few lines of code, I’ve been able to update how my Live Activity appears, and I’ve been able to preview how this will be displayed.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, I'm Anne, and I’m a Frameworks engineer working on watchOS.
    - I’m delighted to show you how to deliver a great experience on Apple Watch for your existing iOS Live Activity.
  - **Review your Live Activity**
    ...
    - When people leave the Lock Screen on iPhone with a Dynamic Island, your Live Activity shifts to showing the compact leading and trailing views in the Dynamic Island.
  - **Customize for Apple Watch**
    - You also have an opportunity to provide a custom Live Activity view for Apple Watch.
    - My app lets people order local produce to their door, and see the status of their deliveries using a Live Activity.
  - **Keep it live**
    - With just a few lines of code, I’ve been able to update how my Live Activity appears, and I’ve been able to preview how this will be displayed.
...
- 이 세션은 **Bring your Live Activity to Apple Watch**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
