...
- 세션 주제: **What’s new in App Intents**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10134/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, my name is Kenny and I’m an engineer on the App Intents team.
  - `Spotlight integration`: Spotlight is a great place to find content that is relevant to you.
  - `Entities and files`: Now let’s talk about how you can make entities meaningful to the device.
  - `Universal links`: Next, lets talk about universal links and how you can represent them with your App Intent types.
...
- 챕터 흐름 요약
  ...
  - **Spotlight integration**
    - Spotlight is a great place to find content that is relevant to you.
    - Spotlight knows the apps I use frequently and offers them as suggestions.
  - **Entities and files**
    - Now let’s talk about how you can make entities meaningful to the device.
    - An AppEntity allows you to define and expose concepts from your app like a Trail.
  - **Universal links**
    - Next, lets talk about universal links and how you can represent them with your App Intent types.
    - Universal Links help people access your content, whether or not they have your app installed.
  - **Developer improvements**
    - This year, we’re also bringing some improvements to the developer experience, making it easier to create AppIntents.
...
- 세션 기반 체크포인트
  ...
  - `Developer improvements`: This year, we’re also bringing some improvements to the developer experience, making it easier to create AppIntents.

## ✅ 핵심 정리

- 이 세션은 **What’s new in App Intents**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
