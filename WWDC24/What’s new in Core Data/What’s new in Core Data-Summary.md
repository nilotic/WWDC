...
- 세션 주제: **What’s new in Core Data**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10186/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Intro`: ♪ ♪ David: Hi, and welcome to “What's New in Core Data.” My name is David Stites, and I'm an engineer on the Core Data team.
  - `Composite attributes`: Composite attributes are a new type of attribute.
  - `Stage your migrations`: As an application evolves, it may become necessary to change the data model.
  - `Defer your migrations`: that your app may not be able to provide in the foreground.
...
- 챕터 흐름 요약
  ...
  - **Defer your migrations**
    - that your app may not be able to provide in the foreground.
...
- 세션 기반 체크포인트
  ...
  - `Wrap-up`: There are three great new technologies in Core Data.

## ✅ 핵심 정리

- 이 세션은 **What’s new in Core Data**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
