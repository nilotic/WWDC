...
- 세션 주제: **Share files with SharePlay**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10241/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Transfer attachments`: Let’s talk through our drawing app.
  - `GroupSessionJournal`: Our main object to familiarize yourself with is the "GroupSessionJournal." This object is new to iOS 17.
  - `Late joiners`: you may remember this topic: Late joiners.
  - `Adopt in DrawTogether`: Now that was a lot of information, so let’s jump into the fun part and see the magic at work and walk through how we would adopt the GroupSessionJournal in our DrawTogether app.
...
- 챕터 흐름 요약
  ...
  - **GroupSessionJournal**
    ...
    - Our main object to familiarize yourself with is the "GroupSessionJournal." This object is new to iOS 17.
  - **Late joiners**
    - you may remember this topic: Late joiners.
...
- 이 세션은 **Share files with SharePlay**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
