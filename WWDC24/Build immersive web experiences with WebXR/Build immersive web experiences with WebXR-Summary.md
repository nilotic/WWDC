...
- 세션 주제: **Build immersive web experiences with WebXR**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10066/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, my name is Ada Rose Cannon.
  - `Discover WebXR`: The chess demo you just saw showed virtual reality in action.
  - `Integrate WebXR`: Firstly, how does WebXR differ from typical Web development?
  - `Test and debug WebXR`: Now we have introduced WebXR, let's take a look at how to test and debug on visionOS specifically.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, my name is Ada Rose Cannon.
    - I am a Safari engineer working on web standards.
  - **Discover WebXR**
    - The chess demo you just saw showed virtual reality in action.
    - Safari on visionOS 2.0 supports immersive virtual reality sessions on the Vision Pro.
  - **Integrate WebXR**
    - Firstly, how does WebXR differ from typical Web development?
    - The web has many ways to display content to users through the document.
  - **Test and debug WebXR**
    - Now we have introduced WebXR, let's take a look at how to test and debug on visionOS specifically.
    - When it comes to testing your content, you can use a real Vision Pro or a visionOS simulator.
...
- 이 세션은 **Build immersive web experiences with WebXR**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
