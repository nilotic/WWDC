...
- 세션 주제: **Extend Speech Synthesis with personal and custom voices**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10033/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Welcome`: ♪ ♪ Grant: Hi, my name is Grant.
  - `Explore SSML`: SSML is a W3C standard for representing spoken text.
  - `Implement a synthesis provider`: your own speech synthesizer voices.
  - `Use Personal Voice`: Let’s move on and talk about a new feature called Personal Voice.
...
- 이 세션은 **Extend Speech Synthesis with personal and custom voices**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
