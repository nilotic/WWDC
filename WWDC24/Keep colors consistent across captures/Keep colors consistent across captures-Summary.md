...
- 세션 주제: **Keep colors consistent across captures**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10162/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Welcome to "Keep colors consistent across captures".
  - `What is color constancy?`: So what is a color constancy?
  - `How Constant Color works`: The Constant Color API makes use of the improved flash hardware first launched in the iPhone 14 family of phones.
  - `Code examples and demos`: Now, lets look at how you can capture Constant Color images in your app.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Welcome to "Keep colors consistent across captures".
    - Hello!
  - **What is color constancy?**
    - So what is a color constancy?
    - It is a property of how human visual perception works.
  - **How Constant Color works**
    - Lets dig a bit deeper in to how the Constant Color feature generates these images.
    - The Constant Color API makes use of the improved flash hardware first launched in the iPhone 14 family of phones.
  - **Code examples and demos**
    - Now, lets look at how you can capture Constant Color images in your app.
    - There are six things you need to be aware of.
  - **Validation**
    - By now, you’re probably wandering how accurate the Constant Color API images are.
    - We tested the API under a range of indoor lighting scenes ranging from 10 Lux to 800 Lux.
...
- 세션 기반 체크포인트
  ...
  - `Validation`: We tested the API under a range of indoor lighting scenes ranging from 10 Lux to 800 Lux.

## ✅ 핵심 정리

- 이 세션은 **Keep colors consistent across captures**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
