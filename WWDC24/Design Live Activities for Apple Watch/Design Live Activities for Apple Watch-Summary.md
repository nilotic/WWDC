...
- 세션 주제: **Design Live Activities for Apple Watch**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10098/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Intro`: Hi, Welcome to Design Live Activities for Apple Watch.
  - `Smart Stack`: In watchOS 11, we’re introducing Suggested Widgets.
  - `Interactions`: To tell you more about how people interact with Live Activities on Apple Watch, here’s Taylor.
  - `Guidelines`: To tell you more about the visual design of Live Activities, here’s Ed.
...
- 챕터 흐름 요약
  ...
  - **Intro**
    - Hi, Welcome to Design Live Activities for Apple Watch.
    - My name is Ed.
  - **Smart Stack**
    - Let’s start with Smart Stack.
    - In watchOS 11, we’re introducing Suggested Widgets.
  - **Interactions**
    - To tell you more about how people interact with Live Activities on Apple Watch, here’s Taylor.
    - We’re really excited about how Live Activities in watchOS 11 bring even more timely, relevant information to your wrist.
  - **Guidelines**
    - To tell you more about the visual design of Live Activities, here’s Ed.
    - Live Activities on Apple Watch are meant to be highly glanceable, providing just the information you need, and nothing more.
...
- 이 세션은 **Design Live Activities for Apple Watch**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
