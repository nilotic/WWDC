...
- 세션 주제: **Dive deeper into SwiftData**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10196/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Intro`: ♪ ♪ Nick Gillett: Hi, I'm Nick Gillett, an Engineer here at Apple on the SwiftData team.
  - `Configuring persistence`: and in this section, I'll take a detailed look at the first role of the model, to describe the structure of persistence and how that works with the ModelContainer.
  - `Track and persist changes`: are two of the most frequently used concepts when writing user interfaces or operating on model objects.
  - `Modeling at scale`: how to work with ModelContext in an application and how well it pairs with SwiftUI.
...
- 챕터 흐름 요약
  ...
  - **Configuring persistence**
    - and in this section, I'll take a detailed look at the first role of the model, to describe the structure of persistence and how that works with the ModelContainer.
    - The ModelContainer is where you describe how data is stored, or persisted, on a device.
  - **Track and persist changes**
    - are two of the most frequently used concepts when writing user interfaces or operating on model objects.
  ...
  - **Modeling at scale**
    - how to work with ModelContext in an application and how well it pairs with SwiftUI.
...
- 세션 기반 체크포인트
  ...
  - `Wrap-up`: In this session, we learned how to create powerful persistence configurations with Schema and ModelConfiguration.

## ✅ 핵심 정리

- 이 세션은 **Dive deeper into SwiftData**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
