...
- 세션 주제: **Track model changes with SwiftData history**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10075/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Fundamentals`: Let’s talk about what SwiftData History is, and why you might want to use it.
  - `Transactions and changes`: History in SwiftData is easy to consume and built on the rich type system of Swift.
  - `Custom stores`: For those of you building custom data stores with SwiftData, your custom store can also support history.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Salutations!
    - My name is David, and I’m an engineer on the SwiftData team.
  - **Fundamentals**
    - Let’s talk about what SwiftData History is, and why you might want to use it.
    - As people use an app, the content stored by SwiftData changes over time.
  - **Transactions and changes**
    - History in SwiftData is easy to consume and built on the rich type system of Swift.
    - Let’s explore how to use it in an app.
  - **Custom stores**
    - For those of you building custom data stores with SwiftData, your custom store can also support history.
    - If your underlying model supports it, you can support these same workflows with your store implementation as well.
...
- 이 세션은 **Track model changes with SwiftData history**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
