...
- 세션 주제: **What’s new in Wallet and Apple Pay**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10108/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, and welcome to "What's new in Wallet & Apple Pay".
  - `Updates to Apple Pay on the web`: If you've implemented Apple Pay using the W3C API instead of Apple Pay JS, keep in mind that not all browsers support the Payment Request API.
  - `Wallet pass enhancements`: Let's talk about what's new with event tickets in Wallet this year.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, and welcome to "What's new in Wallet & Apple Pay".
    - My name is Tanya.
  - **Updates to Apple Pay on the web**
    - The first payments update today is for Apple Pay on the web.
    - If you've implemented Apple Pay using the W3C API instead of Apple Pay JS, keep in mind that not all browsers support the Payment Request API.
...
- 이 세션은 **What’s new in Wallet and Apple Pay**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
