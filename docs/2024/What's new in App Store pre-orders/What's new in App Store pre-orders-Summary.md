...
- 세션 주제: **What’s new in App Store pre-orders**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10015/`
...
- 이 세션은 **What’s new in App Store pre-orders**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
