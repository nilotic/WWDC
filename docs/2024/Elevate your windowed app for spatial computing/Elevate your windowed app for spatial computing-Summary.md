...
- 세션 주제: **Elevate your windowed app for spatial computing**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10110/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `SwiftUI in the Shared Space`: with SwiftUI in mind.
  - `Polishing your app`: and controls feel at home.
  - `Brand new concepts`: we can really take to the skies.
...
- 이 세션은 **Elevate your windowed app for spatial computing**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
