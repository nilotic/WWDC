...
- 세션 주제: **Explore AirPlay with interstitials**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10275/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Overview`: ♪ ♪
  - `Example VOD plan`: Amit: Hi, everyone.
...
- 챕터 흐름 요약
  ...
  - **Optimize AirPlay playback**
  - **Interstitials localization**
  - **Testing**
  - **Example VOD plan**
    - Amit: Hi, everyone.
    - My name is Amit.
...
- 이 세션은 **Explore AirPlay with interstitials**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
