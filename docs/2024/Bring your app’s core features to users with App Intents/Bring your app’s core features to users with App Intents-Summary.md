...
- 세션 주제: **Bring your app’s core features to users with App Intents**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10210/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi!
  - `Friction versus flow`: An important part of a delightful experience is flow.
  - `Understanding the framework`: At this point, you might be saying, this sounds great, I want my app to flow, what do I do?
  - `Building the code`: Now that you have a general idea, let’s write some code.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi!
    - Welcome to Bring your app’s core features to users with App Intents.
  - **Friction versus flow**
    - An important part of a delightful experience is flow.
    - In psychology, that’s the melding of thought and action.
  - **Understanding the framework**
    - At this point, you might be saying, this sounds great, I want my app to flow, what do I do?
    - Glad you asked!
  - **Building the code**
    - Now that you have a general idea, let’s write some code.
...
- 이 세션은 **Bring your app’s core features to users with App Intents**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
