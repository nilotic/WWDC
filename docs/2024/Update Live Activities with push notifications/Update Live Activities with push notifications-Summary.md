...
- 세션 주제: **Update Live Activities with push notifications**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10185/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Intro`: ♪ ♪ Jeff: Hi, I'm Jeff, an engineer on the Live Activities team.
  - `Preparations`: Let's get started with preparations.
  - `First push update`: Now that the preparations are complete, it's time to send your first push update.
  - `Priority and alerts`: And that takes me to a crucial part of designing your user experience, priority and alerts.
...
- 챕터 흐름 요약
  ...
  - **Enhancements**
    - to really polish the Live Activity user experience.
...
- 세션 기반 체크포인트
  ...
  - `Enhancements`: to really polish the Live Activity user experience.
  - `Wrap-up`: Now that you know how to update your Live Activities with push notifications, it's time to add it to your app.

## ✅ 핵심 정리

- 이 세션은 **Update Live Activities with push notifications**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
