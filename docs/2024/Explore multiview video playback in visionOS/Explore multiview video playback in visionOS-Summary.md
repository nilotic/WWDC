...
- 세션 주제: **Explore multiview video playback in visionOS**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10116/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, my name is Eric, and I’m a media experience software engineer.
  - `Introducing multiview`: or I might have two sports games I want to keep an eye on at the same time.
  - `Design a multiview experience`: Multiview is a highly customizable feature.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, my name is Eric, and I’m a media experience software engineer.
    - This talk will go over how to bring simultaneous video watching to your app using the newly available multiview architecture.
  - **Introducing multiview**
    - or I might have two sports games I want to keep an eye on at the same time.
    - Maybe the content I'm watching has multiple available camera angles, and I want that enhanced perspective.
  - **Design a multiview experience**
    - Multiview is a highly customizable feature.
    - Let's go over how to design a compelling and intuitive multiview experience.
...
- 이 세션은 **Explore multiview video playback in visionOS**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
