...
- 세션 주제: **Swift Charts: Vectorized and function plots**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10155/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, I’m Apollo.
  - `Function plots`: I've plotted this video to teach you more about each of these exciting new capabilities of Swift Charts.
  - `Vectorized plots`: That's function plotting with Line Plot and Area Plot, where they treat an entire math function as a single entity.
  - `Best practices`: Now you might be wondering how Vectorized plots and Marks complement each other.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, I’m Apollo.
    - Let me tell you about what's new in Swift Charts.
  - **Function plots**
    - I've plotted this video to teach you more about each of these exciting new capabilities of Swift Charts.
    - Starting with function plots, which introduce two new APIs: LinePlot, for visualizing a single function, And AreaPlot, to fill in the area between two functions.
  - **Vectorized plots**
    - That's function plotting with Line Plot and Area Plot, where they treat an entire math function as a single entity.
    - But the plot APIs are useful for more than just functions.
  - **Best practices**
    - Now you might be wondering how Vectorized plots and Marks complement each other.
...
- 이 세션은 **Swift Charts: Vectorized and function plots**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
