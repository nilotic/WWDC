...
- 세션 주제: **Enhance ad experiences with HLS interstitials**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10114/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Interstitals recap`: Lets quickly review HLS interstitials.
  - `Integrated timeline`: called Integrated Timeline.
  - `SharePlay with interstitials`: to be presented part of the primary content in the UI, it would make sense that these interstitials can also be coordinated during a SharePlay session.
...
- 챕터 흐름 요약
  ...
  - **Interstitals recap**
    ...
    - With HLS interstitials, ads or interstitials are separate assets that can be scheduled on the main content timeline.
  - **Integrated timeline**
    - called Integrated Timeline.
    - This API introduces a data model for timing and sequence of playback of content with interstitials.
  - **SharePlay with interstitials**
    - to be presented part of the primary content in the UI, it would make sense that these interstitials can also be coordinated during a SharePlay session.
    - So this year, we are adding support for interstitials to be coordinated.
...
- 이 세션은 **Enhance ad experiences with HLS interstitials**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
