...
- 세션 주제: **Design advanced games for Apple platforms**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10085/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi I'm Linda, from the Design Evangelism Team.
  - `Design for the device`: So let's start with designing for the device.
  - `Design for input`: Thanks Linda!
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi I'm Linda, from the Design Evangelism Team.
    - If you're new to developing games for Apple platforms, it's never been a better time jump in.
  - **Design for the device**
    - So let's start with designing for the device.
    - Delivering a great game experience means being considerate of how your game's defaults, layout, text, and controls will feel for your players on Apple devices.
  - **Design for input**
    - Thanks Linda!
    - Hi, I'm Dylan, from the Apple design team.
...
- 이 세션은 **Design advanced games for Apple platforms**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
