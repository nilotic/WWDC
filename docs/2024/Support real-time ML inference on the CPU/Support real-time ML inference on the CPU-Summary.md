...
- 세션 주제: **Support real-time ML inference on the CPU**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10211/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi, my name is Simon Gladman and I work for the Vector & Numerics Group here at Apple.
  - `Introducing BNNS Graph`: and let’s dive into BNNS Graph.
  - `Real-time processing`: So, because our new API is ideally suited to real-time use cases.
  - `Adopting BNNS Graph`: I’m now going to show you how to create an audio unit project that adopts BNNS Graph.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hi, my name is Simon Gladman and I work for the Vector & Numerics Group here at Apple.
    - Today, I’ll be talking about some exciting new functionality in our machine learning library, Basic Neural Network Subroutines or BNNS.
  - **Introducing BNNS Graph**
    - and let’s dive into BNNS Graph.
    - Just before we get started, let me share how BNNS fits into Apple’s overall stack of machine learning frameworks.
  - **Real-time processing**
    - So, because our new API is ideally suited to real-time use cases.
    - I’ll be looking at such a use-case, working with audio by adding BNNS Graph to an AudioUnit.
  - **Adopting BNNS Graph**
  ...
  - **BNNS Graph in Swift**
    ...
    - One perfect use-case for using Swift is to implement our BNNS Graph into the SwiftUI component of our audio unit.
...
- 세션 기반 체크포인트
  ...
  - `BNNS Graph in Swift`: Finally, let’s take a look at how to integrate BNNS Graph in a Swift project.

## ✅ 핵심 정리

- 이 세션은 **Support real-time ML inference on the CPU**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
