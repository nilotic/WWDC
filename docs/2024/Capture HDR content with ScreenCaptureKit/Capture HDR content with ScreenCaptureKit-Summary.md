...
- 세션 주제: **Capture HDR content with ScreenCaptureKit**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10088/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction and ScreenCaptureKit recap`: Hello and welcome!
  - `Capture HDR content`: In order to understand how to capture HDR content, let’s first get familiar with the basics for capturing screen and audio.
  - `Add microphone output`: you can get started capturing HDR images and video with ScreenCaptureKit.
  - `Record to file`: is to write the samples to a file.
...
- 챕터 흐름 요약
  ...
  - **Introduction and ScreenCaptureKit recap**
    - Hello and welcome!
    - My name is Ben, I am a software engineer on the ScreenCaptureKit team.
  - **Capture HDR content**
  ...
  - **Add microphone output**
    - you can get started capturing HDR images and video with ScreenCaptureKit.
    - To accompany your beautiful HDR streams, this year, you can also record the microphone along with your system audio.
  - **Record to file**
    - is to write the samples to a file.
    - You can now accomplish this by using a new API that has been added to the SCStream.
...
- 이 세션은 **Capture HDR content with ScreenCaptureKit**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
