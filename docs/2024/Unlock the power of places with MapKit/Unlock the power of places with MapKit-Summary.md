...
- 세션 주제: **Unlock the power of places with MapKit**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10097/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Reference a place`: First up, I'll tell you about how to reference a place.
  - `Display place details`: APIs are available for UIKit, AppKit, and SwiftUI.
  - `Find a place`: that you found with the Place ID lookup tool, you'll probably need your app to search for some places!
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Welcome!
    - I'm Mike, and howdy, I'm Jeff.
  - **Reference a place**
    - First up, I'll tell you about how to reference a place.
    - This year, we're introducing an identifier for places.
  - **Display place details**
    - Next up?
    - APIs are available for UIKit, AppKit, and SwiftUI.
  - **Find a place**
    - that you found with the Place ID lookup tool, you'll probably need your app to search for some places!
    - We've made improvements to our search API this year, including new ways to filter search results.
...
- 이 세션은 **Unlock the power of places with MapKit**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
