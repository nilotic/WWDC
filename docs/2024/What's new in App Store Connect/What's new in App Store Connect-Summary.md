...
- 세션 주제: **What’s new in App Store Connect**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10063/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hi and welcome to What’s new in App Store Connect.
  - `Get discovered`: Let’s start with ways to get your app discovered.
  - `Test your app`: Let’s talk about testing your app.
  - `Reach customers`: Let’s talk about reaching customers for your app.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    ...
    - I’m Victor from TestFlight Engineering.
  - **Get discovered**
    - Let’s start with ways to get your app discovered.
    - Every day our Editorial team creates new stories and collections that appear throughout the App Store, showcasing your exceptional apps and games.
  - **Test your app**
    - Let’s talk about testing your app.
    - You have an exciting new update to your AwayFinder app that Daymon just talked about in Featuring Nominations.
  - **Reach customers**
    - Let’s talk about reaching customers for your app.
    - The next feature will allow you to create a more seamless experience when you reach customers through the App Store.
...
- 이 세션은 **What’s new in App Store Connect**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
