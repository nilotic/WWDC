...
- 세션 주제: **Migrate to SwiftData**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2023/10189/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Intro`: ♪ ♪ Luvena: Hi everyone!
  - `Generate model classes`: In SwiftData, you are transitioning to using models in code to set up your schema.
  - `Complete adoption`: When fully migrating your application to SwiftData, you are replacing your Core Data stack with your SwiftData stack to harness the Swift-native language features with SwiftData.
  - `Coexists with Core Data`: to SwiftData completely, let me take you through the case where you want coexistence between Core Data and SwiftData.
...
- 챕터 흐름 요약
  ...
  - **Coexists with Core Data**
    - to SwiftData completely, let me take you through the case where you want coexistence between Core Data and SwiftData.
...
- 세션 기반 체크포인트
  ...
  - `Wrap-up`: That’s all from me!

## ✅ 핵심 정리

- 이 세션은 **Migrate to SwiftData**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
