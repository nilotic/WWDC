...
- 세션 주제: **Bring your iOS or iPadOS game to visionOS**
- 세션 링크: `https://developer.apple.com/videos/play/wwdc2024/10093/`
...
- 이 세션에서 특히 봐야 할 포인트
  ...
  - `Introduction`: Hello.
  - `Render on visionOS`: You can do 3D rendering on visionOS with RealityKit and Metal.
  - `Compatible to native`: is to run your game as a compatible app on visionOS.
  - `Add a frame and a background`: we can add visionOS specific features.
...
- 챕터 흐름 요약
  ...
  - **Introduction**
    - Hello.
    - I'm Olivier, a Software Engineer on RealityKit and visionOS.
  - **Render on visionOS**
    - You can do 3D rendering on visionOS with RealityKit and Metal.
    - RealityKit is a framework that you can use directly in Swift or indirectly through technologies like Unity PolySpatial.
  - **Compatible to native**
    - is to run your game as a compatible app on visionOS.
    - I'll use the Metal Deferred Lighting sample as an example of an iOS game.
  - **Add a frame and a background**
    - we can add visionOS specific features.
    - The game Cut The Rope 3 has a dynamic frame around its window.
  - **Enhance the rendering**
    - I'll now take you through some techniques you can use to enhance the Metal rendering of your game.
    - If you want objects to come out of the bounds of the rectangle, you can render them with RealityKit and APIs such as the new portal-crossing API.
...
- 세션 기반 체크포인트
  ...
  - `Enhance the rendering`: I'll now take you through some techniques you can use to enhance the Metal rendering of your game.

## ✅ 핵심 정리

- 이 세션은 **Bring your iOS or iPadOS game to visionOS**를 단순 기능 소개가 아니라, 실제 제품/서비스 코드에 적용할 때 필요한 설계 판단 관점까지 연결해 이해하는 데 가치가 있습니다.
